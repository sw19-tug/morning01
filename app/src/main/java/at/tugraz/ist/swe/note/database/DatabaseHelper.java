...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase dataBase) {
        dataBase.execSQL("CREATE TABLE " + NOTE_TABLE_NAME + " (" +
                ...
                NOTE_COLUMN_CREATED_DATE + " DATETIME DEFAULT CURRENT_TIMESTAMP, " +
                NOTE_COLUMN_CHANGED_DATE + " DATETIME DEFAULT CURRENT_TIMESTAMP, " +
                NOTE_COLUMN_PINNED + " INTEGER DEFAULT 0, " +
                NOTE_COLUMN_REMOVED + " BOOLEAN DEFAULT False" +")");
    }
